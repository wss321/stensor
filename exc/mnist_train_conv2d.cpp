...
class SimpleNet : public nn::Module {
 public:
  SimpleNet(int dim_in, int num_classes, int device_id = 0) {
    ...
    type_ = "Custom";
    name_ = "SimpleNet";
    auto conv1 = new nn::Conv2d("conv1", 1, 4, 3, 3, 1, 1, 1, 1, 1, 1, 1, device_id, false);
    auto act1 = new nn::ReLU("act1", device_id, true);
//    auto pool1 = new nn::Pooling2d("pool1", nn::MAXPOOL, 2, 2, device_id);
    auto pool1 = new nn::MaxPool2d("pool1", 2, 2, device_id);

    auto conv2 = new nn::Conv2d("conv2", 4, 8, 3, 3, 1, 1, 1, 1, 1, 1, 1, device_id, false);
    auto act2 = new nn::ReLU("act2", device_id, true);
//    auto pool2 = new nn::Pooling2d("pool2", nn::MAXPOOL, 2, 2, device_id);
    auto pool2 = new nn::MaxPool2d("pool2", 2, 2, device_id);
    auto reshape = new nn::Reshape("reshape", {-1, 8 * 7 * 7});
    auto l1 = new nn::Linear("l1", 8 * dim_in / 16, 64, axis, device_id, true);
    auto act3 = new nn::ReLU("act3", device_id, true);
    auto l2 = new nn::Linear("l2", 64, num_classes, axis, device_id, true);

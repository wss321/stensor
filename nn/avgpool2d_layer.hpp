...
#ifndef STENSOR_NN_AVGPOOL2D_LAYER_HPP_
#define STENSOR_NN_AVGPOOL2D_LAYER_HPP_
...
namespace nn {
  ...
  public:
      explicit AvgPool2d(std::string name,
  ...
  DISABLE_COPY_AND_ASSIGN(AvgPool2d);
  };
}//namespace nn

}//namespace stensor
#endif //STENSOR_NN_AVGPOOL2D_LAYER_HPP_
